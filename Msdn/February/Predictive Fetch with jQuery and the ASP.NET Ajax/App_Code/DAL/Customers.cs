...
namespace Core35.DAL
{
    ...
    public sealed class NoCustomer : Customer
    {
        public static readonly NoCustomer Instance = new NoCustomer();
        
        public string Tag
        {
            get { return "Null Customer"; }
        }
    }
