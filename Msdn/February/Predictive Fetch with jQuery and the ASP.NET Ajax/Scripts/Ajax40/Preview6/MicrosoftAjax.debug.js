...
$addHandler = Sys.UI.DomEvent.addHandler = function Sys$UI$DomEvent$addHandler(element, eventName, handler, autoRemove) {
...
$addHandlers = Sys.UI.DomEvent.addHandlers = function Sys$UI$DomEvent$addHandlers(element, events, handlerOwner, autoRemove) {
...
$clearHandlers = Sys.UI.DomEvent.clearHandlers = function Sys$UI$DomEvent$clearHandlers(element) {
...
if (document.documentElement.getBoundingClientRect) {
    Sys.UI.DomElement.getLocation = function Sys$UI$DomElement$getLocation(element) {
        ...
        if (e) throw e;
                                                if (element.self || element.nodeType === 9 ||             (element === document.documentElement) ||             (element.parentNode === element.ownerDocument.documentElement)) {             return new Sys.UI.Point(0, 0);
        }        
...
Sys.UI.DomElement.setCommand = function Sys$UI$DomElement$setCommand(commandSource, commandName, commandArgument, commandTarget) {
    ...
    /// <param name="commandSource" domElement="true"></param>
    ...
    var e = Function._validateParams(arguments, [
        {name: "commandSource", domElement: true},
...
Sys.Net.WebServiceProxy.invoke = function Sys$Net$WebServiceProxy$invoke(servicePath, methodName, useGet, params, onSuccess, onFailure, userContext, timeout, enableJsonp, jsonpCallbackParameter) {
    ...
    if (jsonp) {
        ...
        Sys.loader._loadSrc(url, function() {
            if (tempCallback) {
